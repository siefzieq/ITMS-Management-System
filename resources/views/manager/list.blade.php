            ...
            <div class="col">
                <div class="card" style=" width: 60rem;; border-radius: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3); ">
                    <div class="card-body">
                        ...
                        <p class="card-text">Requestor : {{$p->order->requestor??'None'}}</p>
                        <a class="btn btn-info float-right" style="background-color:#0461AA;" href="{{ route('project.show', $p->id) }}">More info</a>
                    </div>
                </div>
                <br>
            </div>
